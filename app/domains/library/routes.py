...
@mainstream_router.get("", response_model=List[MetadataMatchRead] if "MetadataMatchRead" in globals() else List[Any] if "Any" in globals() else list)
...
@adult_router.get("", response_model=List[MetadataMatchRead] if "MetadataMatchRead" in globals() else List[Any] if "Any" in globals() else list)
...
from app.domains.library.services.library_detail_service import LibraryDetailService
